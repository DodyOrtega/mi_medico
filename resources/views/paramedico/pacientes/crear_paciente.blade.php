...
@section('seccion_titulo','Registrar Paciente')
...
<div class="medicos-page">
    ...
    <form method="POST" action="{{ route('paramedico.pacientes.guardar') }}" class="form-card" id="formGuardar">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group" id="nueva_etnia_wrap" style="display:none">
                ...
                <input type="text" name="nueva_etnia" placeholder="Nombre de la etnia" oninput="this.value=this.value.toUpperCase()">
            </div>
            <div class="form-group">
        ...
        <div class="form-grid">
            ...
            <div class="form-group form-group--full">
                ...
                <textarea name="medicacion_habitual" rows="2">{{ old('medicacion_habitual') }}</textarea>
            </div>
        </div>
...
function toggleNuevaEtnia() {
    document.getElementById('nueva_etnia_wrap').style.display =
        document.getElementById('etnia_select').value === 'nueva' ? 'block' : 'none';
}
